...
class EmailTrackingService {
    ...
    async processProviderWebhook(providerMessageId, eventType, providerPayload, metadataJson) {
        ...
        return await prisma.$transaction(async (tx) => {
            ...
            let newLeadStatus = '';
            if (eventType === 'OPENED')
                newLeadStatus = 'Opened';
            else if (eventType === 'CLICKED')
                newLeadStatus = 'Clicked';
            ...
            if (newLeadStatus) {
                ...
                if (newRank > currentRank) {
                    const updatePayload = { engagementStatus: newLeadStatus };
            ...
            if (['OPENED', 'CLICKED', 'REPLIED'].includes(eventType) && messageSend.lead.userId) {
                ...
                socket_service_1.SocketService.sendToUser(messageSend.lead.userId, 'new_notification', notif);
            }
            return event;
        });
    }
