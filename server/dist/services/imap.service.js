...
exports.checkIMAPReplies = void 0;
const imap_simple_1 = __importDefault(require("imap-simple"));
const mailparser_1 = require("mailparser");
const client_1 = require("@prisma/client");
const socket_service_1 = require("./socket.service");
const prisma = new client_1.PrismaClient();
const checkIMAPReplies = async () => {
    try {
        const imapSetting = await prisma.integrationSetting.findUnique({
        ...
        if (messages.length > 0) {
            ...
            for (const item of messages) {
                ...
                if (!all)
                    continue;
                try {
                    const mail = await (0, mailparser_1.simpleParser)(idHeader + all.body);
...
exports.checkIMAPReplies = checkIMAPReplies;
