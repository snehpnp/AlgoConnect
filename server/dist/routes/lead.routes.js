...
router.post('/:id/send-message', auth_middleware_1.authenticate, lead_controller_1.sendDirectMessage);
router.get('/:id/messages', auth_middleware_1.authenticate, lead_controller_1.getLeadMessageHistory);
